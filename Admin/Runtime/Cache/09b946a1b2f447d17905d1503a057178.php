				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-title">
							<h5>商品回收站列表</h5>
							<input style="margin-top:5px;" type="submit" class="icon" name="submitd" value="批量删除">
						</div>
						<!-- 组件内容区域 -->
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<thead>
									<tr>	
										<th width="50"><input type="checkbox">全选</th>
										<th>货号</th>
										<th>名称</th>
										<th width="60">商品图片</th>
										<th>价格</th>
								...
								<!-- 表格主体数据区域 -->
								<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr height="30">
										<td><input type="checkbox" name="all[]" value="<?php echo ($v["id"]); ?>"/></td>
										<td><?php echo ($v["gnum"]); ?></td>
										<td><?php echo ($v["gname"]); ?></td>
										<td><a href="__PUBLIC__/Uploads/goods/<?php echo ($v["pic"]); ?>"><img src="__PUBLIC__/Uploads/goods/<?php echo ($v["pic"]); ?>" alt="<?php echo ($v["gname"]); ?>" title="<?php echo ($vo["gname"]); ?>" style="height:40px;width:50px;"></a></td>
										<td><?php echo ($v["price"]); ?></td>	
										<td><?php echo (date("Y-m-d H:i:s",$v["selltime"])); ?></td>
										<td class="taskOptions">
					
									    	<a href="__URL__/back/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="还原"><i class="icon-backward"></i></a>
										&nbsp;&nbsp;
									    	<a href="__URL__/del/id/<?php echo ($v["id"]); ?>" class="tip-top" data-original-title="彻底删除" onclick="return confirm('你确定要彻底删除!!!')"><i class="icon-remove"></i></a>
										</td>
