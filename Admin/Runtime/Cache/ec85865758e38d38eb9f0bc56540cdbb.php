...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="#" class="current"> 订单基本信息编辑</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
					...
					<!-- 组件盒子 开始 -->
					    ...
					    <div class="widget-box">
						        ...
						        <div class="widget-content nopadding">
						          <form action="__URL__/updatej/id/<?php echo ($order["id"]); ?>" method="post" class="form-horizontal">
						            <div class="control-group">
						              <label class="control-label">订单号:</label>
						              <div class="controls">
						                <input type="text" class="span11" name="ordernum" value="<?php echo ($order["ordernum"]); ?>" disabled/>
						              </div>
						            </div>
						            <div class="control-group">
						              <label class="control-label">购货人 :</label>
						              <div class="controls">
						                <input type="text" class="span11" name="uid" value="<?php echo ($user["username"]); ?>" disabled/>
						              </div>
						            </div>
									...
									<select name="orderstatus" style="width:100px;">
						                		<option value="1" <?php if($order["orderstatus"] == 1): ?>selected<?php endif; ?>>已确认</option>
						                		<option value="2" <?php if($order["orderstatus"] == 2): ?>selected<?php endif; ?>>未确认</option>
						                	</select>
						              </div>
						            </div>
									...
									<select name="paystatus" style="width:100px;">
						                		<option value="1" <?php if($order["paystatus"] == 1): ?>selected<?php endif; ?>>已付款</option>
						                		<option value="2" <?php if($order["paystatus"] == 2): ?>selected<?php endif; ?>>未付款</option>
						                	</select>
						              </div>
						            </div>
									...
									<select name="sendstatus" style="width:100px;">
						                		<option value="1>" <?php if($order["paystatus"] == 1): ?>selected<?php endif; ?>>已发货</option>
						                		<option value="2" <?php if($order["paystatus"] == 2): ?>selected<?php endif; ?>>未发货</option>
						                		<option value="3" <?php if($order["paystatus"] == 3): ?>selected<?php endif; ?>>完成交易</option>
						             ...
						             <div class="control-group">
						              ...
						              <div class="controls">
						                <input type="text" class="span11" name="addtime" value="<?php echo (date('Y-m-d H:i',$order["addtime"])); ?>"  disabled/>
						              </div>
						            </div>
						             ...
						             <div class="control-group">
						              ...
						              <div class="controls">
						                <input type="text" class="span11" name="paytime" value="<?php if($order["paytime"] == 0): ?>未付款<?php else: echo (date('Y-m-d H:i',$order["paytime"])); endif; ?>" disabled/>
						              </div>
						            </div>
						             ...
						             <div class="control-group">
						              ...
						              <div class="controls">
						                <input type="text" class="span11" name="sendtime" value="<?php if($order["sendtime"] == 0): ?>未发货<?php else: echo (date('Y-m-d H:i',$order["sendtime"])); endif; ?>" disabled/>
						              </div>
						            </div>
