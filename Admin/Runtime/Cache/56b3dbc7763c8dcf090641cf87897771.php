				...
				<div class="span12">
					...
					<div class="widget-box">
						...
						<div class="widget-title">
							<h5>规格列表</h5>
							<input class="icon" style="margin-top:5px;" type="button" name="add" id="add" value="添加规格">
							...
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td class="taskOptions">
									    	...
									    	<a href="__URL__/del/id/<?php echo ($vo["id"]); ?>" class="tip-top" data-original-title="删除" onclick="return confirm('是否要删除数据')"><i class="icon-remove"></i></a>
										</td>
