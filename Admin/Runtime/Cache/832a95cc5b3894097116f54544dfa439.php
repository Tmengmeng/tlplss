								...
								<div class="control-group">
									...
									<div class="controls">
										<select style="width:80px;" name="year">
											<?php $__FOR_START_5320__=1938;$__FOR_END_5320__=2014;for($i=$__FOR_START_5320__;$i < $__FOR_END_5320__;$i+=1){ ?><option <?php if($info['birthday'][0] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="month">
											<?php $__FOR_START_31073__=1;$__FOR_END_31073__=12;for($i=$__FOR_START_31073__;$i < $__FOR_END_31073__;$i+=1){ ?><option <?php if($info['birthday'][1] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="day">
											<?php $__FOR_START_27782__=1;$__FOR_END_27782__=31;for($i=$__FOR_START_27782__;$i < $__FOR_END_27782__;$i+=1){ ?><option <?php if($info['birthday'][2] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
									</div>
								</div>
								<div class="control-group">
