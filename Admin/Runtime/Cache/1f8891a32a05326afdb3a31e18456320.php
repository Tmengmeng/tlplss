						...
						<div class="widget-content nopadding">
							<table class="table table-bordered data-table">
								...
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td>
											<font color="green">
											<?php if($vo["orderstatus"] == 1): ?>已确认
													<?php else: ?>未确认<?php endif; ?>
											</font>
											<font color="red">
											<?php if($vo["paystatus"] == 1): ?>已付款
													<?php else: ?>未付款<?php endif; ?>
											<?php if($vo["sendstatus"] == 1): ?>已发货
													<?php elseif($vo["sendstatus"] == 2): ?>未发货
